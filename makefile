...
web:
	$(WEBCC) -o geo.html main.cpp -Os -Wall ./libwebraylib.a -I. -I./raylib -L. -L./lwebraylib.a -s USE_GLFW=3 -s ASYNCIFY -sASSERTIONS --shell-file /home/pavel/sources/raylib/src/minshell.html $(ASSETS) -sINITIAL_MEMORY=67895296 -DPLATFORM_WEB
